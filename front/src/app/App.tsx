...
export default function App() {
  ...
  const sampleMeasurements = [
    { parameter: 'Ángulo Cobb', value: 15.2, unit: '°', normalRange: '< 10°', status: 'warning' as const },
    { parameter: 'Inclinación pélvica', value: 8.5, unit: '°', normalRange: '5-10°', status: 'normal' as const },
    { parameter: 'Lordosis lumbar', value: 42.1, unit: '°', normalRange: '40-60°', status: 'normal' as const },
    { parameter: 'Cifosis torácica', value: 38.7, unit: '°', normalRange: '20-45°', status: 'normal' as const },
    { parameter: 'Desviación lateral', value: 12.3, unit: 'mm', normalRange: '< 5mm', status: 'critical' as const },
  ];
  ...
  const handleNormalizeImage = async () => {
    ...
    try {
      ...
      if (result.success && result.normalized_image_url) {
        setNormalizedImageUrl(result.normalized_image_url);
        toast.success('Imagen normalizada exitosamente');
      } else {
        toast.error(result.error || 'Error al normalizar la imagen');
      }
    } catch (error) {
      ...
      <div className="min-h-full p-6">
        ...
        <div className="grid grid-cols-12 gap-4">
          <div className="col-span-3 space-y-4">
            ...
            <SpineDiagram highlightedVertebrae={['T8', 'T9', 'T10', 'L1']} />
          </div>
